...
import com.app.cellular.mobile.AgentBatchesReceived.AgentBatchesReceived;
import com.app.cellular.mobile.AgentBatchesReceived.AgentNormalBatchesReceivedList;
...
public class AgentReceiveBatchesTab extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            tabHost.getTabWidget().getChildAt(0).setBackgroundColor(Color.parseColor("#08265e")); // unselected
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                for (int i = 0; i < tabHost.getTabWidget().getChildCount(); i++) {
                    ...
                    tabHost.getTabWidget().getChildAt(i).setBackgroundColor(Color.parseColor("#2156BC")); // unselected
                    tv.setTextColor(Color.parseColor("#FFFD6E"));
                }

                tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab()).setBackgroundColor(Color.parseColor("#08265e")); // selected
